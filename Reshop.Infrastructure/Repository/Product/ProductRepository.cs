...
namespace Reshop.Infrastructure.Repository.Product
{
    public class ProductRepository : IProductRepository
    {
        ...
        public IEnumerable<ProductViewModel> GetProductsOfChildCategoryWithPagination(int childCategoryId, string type, string sortBy, int skip = 0,
            int take = 18, string filter = null, decimal minPrice = 0, decimal maxPrice = 0, List<int> brands = null)
        {
            IQueryable<ShopperProductColor> products = _context.ChildCategories
                 .Where(c => c.ChildCategoryId == childCategoryId)
                 .SelectMany(c => c.Products)
        ...
        public async Task<decimal> GetMaxPriceOfChildCategoryProductsAsync(int childCategoryId, string type, string filter = null,
            List<int> brands = null)
        {
            IQueryable<ShopperProductColor> products = _context.ChildCategories
                .Where(c => c.ChildCategoryId == childCategoryId)
        ...
        public async Task<decimal> GetMinPriceOfChildCategoryProductsAsync(int childCategoryId, string type, string filter = null,
            List<int> brands = null)
        {
            IQueryable<ShopperProductColor> products = _context.ChildCategories
                .Where(c => c.ChildCategoryId == childCategoryId)
        ...
        public async Task<int> GetChildCategoryProductsCountAsync(int childCategoryId, string type, string filter = null, decimal minPrice = 0,
            decimal maxPrice = 0, List<int> brands = null)
        {
            IQueryable<ShopperProductColor> products = _context.ChildCategories
                .Where(c => c.ChildCategoryId == childCategoryId)
        ...
        public async Task<EditMobileProductViewModel> GetTypeMobileProductDataForEditAsync(int productId)
        {
            return await _context.Products
                ...
                .Select(c => new EditMobileProductViewModel()
                {
                    ...
                    SoftWareMoreInformation = c.MobileDetail.SoftWareMoreInformation,
